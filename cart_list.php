            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Contenu de votre panier</h3>
        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Panier</b></div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4 text-right">
			        			<b><large><?php echo number_format($row['qty'] * $row['price'],2) ?> Fcfa</large></b>
			        		</div>
		        		</div>
	        		</div>
	        	</div>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Montant a payé</large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,2) ?> Fcfa</b></p>
        					<hr>
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-primary" type="button" id="checkout">Passez à la caisse</button>
        					</div>
        				</div>
        			</div>
        		</div>
    ...
    <script>
		...
		$('#checkout').click(function(){
			if('<?php echo isset($_SESSION['login_user_id']) ?>' == 1){
				...
				uni_modal("Commander","login.php?page=checkout")
			}
		})
    </script>
