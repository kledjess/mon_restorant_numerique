	...
	<div class="card ">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
          	<button class="btn btn-outline-primary btn-sm btn-block" id="add_to_cart_modal"><i class="fa fa-cart-plus"></i>Ajouté au panier</button>
          </div>
        </div>
	...
	$('#add_to_cart_modal').click(function(){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1 )
					alert_toast("Commande ajoutée au panier avec succès");
