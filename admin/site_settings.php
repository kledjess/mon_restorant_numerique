	...
	<div class="card col-lg-12">
		<div class="card-body">
			<form action="" id="manage-settings">
				...
				<div class="form-group">
					<label for="about" class="control-label">À propos du contenu</label>
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-2">Enregistrer</button>
				</center>
			</form>
		</div>
	</div>
	...
	$('#manage-settings').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Données enregistrées avec succès.','succès')
					setTimeout(function(){
						location.reload()
					},1000)
				}
