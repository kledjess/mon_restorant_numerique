							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_cat" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" >Modifier</button>
...
<script>
	...
	$('.delete_cat').click(function(){
		_conf("Êtes-vous sûr de vouloir supprimer cette catégorie ?","supprimer",[$(this).attr('data-id')])
	})
